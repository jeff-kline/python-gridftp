...
BuildRequires: python >= 2.6.6, gcc, python-devel, globus-ftp-client-devel, globus-ftp-control-devel,globus-usage-devel

Requires: python >= 2.6.6, globus-ftp-client >= 6.0, globus-ftp-control >= 2.12 
